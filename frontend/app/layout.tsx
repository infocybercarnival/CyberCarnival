...
export const metadata: Metadata = {
  ...
  icons: {
    icon: '/assets/branding/cybercarnival-logo-favicon.jpeg',
    shortcut: '/assets/branding/cybercarnival-logo-favicon.jpeg',
    apple: '/assets/branding/cybercarnival-logo-favicon.jpeg',
  },
}
