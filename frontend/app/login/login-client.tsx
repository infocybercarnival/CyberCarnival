...
import { initiateGoogleLogin, loginWithPassword, ApiValidationError } from '@/lib/api'
...
export function LoginClient() {
  ...
  const [status, setStatus] = useState<'idle' | 'authenticating' | 'google_connecting' | 'success'>('idle')
  ...
  const handlePasswordLogin = async (e: FormEvent) => {
    ...
    try {
      await loginWithPassword({ username: username.trim(), password, turnstileToken })
      setStatus('success')
